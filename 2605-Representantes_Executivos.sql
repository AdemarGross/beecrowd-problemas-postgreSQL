/* 
EXERCÍCIO  2505 - REPRESENTANTES EXECUTIVOS
...
-- RESPOSTA
select products.name, providers.name from providers join products
on id_providers = providers.id where id_categories = '6';